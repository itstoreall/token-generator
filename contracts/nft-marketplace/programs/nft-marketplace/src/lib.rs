...
// The struct to mint an NFT (this is the struct we'll pass in as instructions)
#[derive(Accounts)]
...
declare_id!("86UbSLXhvcAE6WcgyWAeMXZi58J7WHW5NvNqFdeTPPUx");
...
pub mod nft_marketplace {
    ...
    pub fn mint_nft(
        ...
        // Invoke the Solana programs to create the MetaData accounts (wrapped nicely in Anchor instructions)
        invoke(
        ...
        // Invoke the Solana programs to mint the NFT to the reciever's account (wrapped nicely in Anchor instructions)
        invoke(
